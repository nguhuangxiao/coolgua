...
var _layout2 = __webpack_require__(1512);
...
var _field = __webpack_require__(1514);
...
var ActivityAdd = function (_Component) {
  ...
  function ActivityAdd(props, context) {
    ...
    _this.registerTimeChange = function (field, value, dateString) {
      _this.setState(_defineProperty({}, field, dateString));
    };

    _this.registerStartChange = function (value, dateString) {
      if (_this.state.endTime) {
        if (value.valueOf() >= _this.state.endTime.valueOf() + 86400) {
          _message3.default.error("报名开始时间不能晚于活动截止时间");
          return;
        }
      }
  ...
  _createClass(ActivityAdd, [{
    ...
    value: function cascadeProvinceChange(value) {
      ...
      this.setState({ province: value }, function () {
        ...
        result.then(function (res) {
          ...
          _this2.setState({ city: "城市", "allCity": cdata });
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'activity-main activity-add-main' },
            _react2.default.createElement(
              'div',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(_input2.default, { className: 'form-input', name: 'name', id: 'name', placeholder: '\u6D3B\u52A8\u4E3B\u9898\u5B57\u6570\u4E0D\u80FD\u8D85\u8FC720\u4E2A\u6C49\u5B57', onChange: this.handleChange.bind(this) })
              ),
              _react2.default.createElement(
                'div',
                { className: 'item' },
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'more-address', style: { width: 765 } },
                  _react2.default.createElement(
                    'span',
                    null,
                    '\u8BE6\u7EC6\u5730\u5740'
                  ),
                  _react2.default.createElement(_input2.default, { className: 'form-input', id: 'address', name: 'address', onChange: this.handleChange.bind(this) })
                )
              ),
              _react2.default.createElement(
                'div',
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', name: 'color', readOnly: true, id: 'color', ref: 'color', onChange: this.handleChange.bind(this), className: 'ant-input iColorPicker color-ant' }),
                _react2.default.createElement(
                  'a',
    ...
    value: function saveActivity() {
      ...
      var layout = (0, _layout2.createLayout)();
      if (this.testActivity()) {
        var _layout = (0, _layout2.createLayout)();
        var data = {};
        ...
        data['layout'] = JSON.stringify(_layout);
        console.log(data);
        var result = (0, _activity_add.saveActivityData)(data);
        result.then(function (res) {
          if (res.code === 200) {
            _message3.default.success('创建活动成功');
            setTimeout(function () {
    ...
    value: function componentDidMount() {
      ...
      iColorPicker();
      That = this;
      var editor = new _wangeditor2.default(_reactDom2.default.findDOMNode(this.editorDom));
...
function createLayout() {
  ...
  for (var i = 0; i < oLi.length; i++) {
    ...
    var fieldId = parseInt(oLi[i].getAttribute('fieldId'));
...
var _field = __webpack_require__(1513);
